"""
Django settings for quiet_snow_39832 project.
...
ROOT_URLCONF = 'quiet_snow_39832.urls'
...
WSGI_APPLICATION = 'quiet_snow_39832.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_snow_39832 API",
    "DESCRIPTION": "API documentation for quiet_snow_39832 App",
    "VERSION": "v1",
}
